	...
	return (
      ...
      <div className="container" data-aos="fade-up">
        ...
        <div className="row g-0">
          ...
          <div className="col-lg-4 reservation-img" style={{backgroundImage: "url(assets/img/place-1.png)"}} data-aos="zoom-out" data-aos-delay="200"></div>

          <div className="col-lg-8 d-flex align-items-center reservation-form-bg">
            <form action="forms/book-a-table.php" method="post" role="main" className="php-email-form" data-aos="fade-up" data-aos-delay="100">
